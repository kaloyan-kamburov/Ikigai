        ...
        <ul className="wizard">
          ...
          <div className="col-wrapper">
                      ...
                      <form onSubmit={props.handleSubmit}>
                        ...
                        />
                         <div className="form-btns">
                            <button className="btn-small btn-light" disabled={props.invalid} type="submit">
                              Continue
                            </button>
                        </div>
                      </form>
            ...
            <div className="col_40 form-questions">
              <h2 className="form-questions-title">This question is meant to figure out your natural gifts: your talents and skills.</h2>
              <ul className="form-questions-list">
                <li>  What parts of your current job are you effortless good at?</li>
                <li>What are you among the best in your workplace, community (or even the whole world) at?</li>
                <li>With some more education and experience, could you be among the best at what you do?</li>
              </ul>
            </div>
          </div>
        </div>
